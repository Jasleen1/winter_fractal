...
> AccumulatorVerifier<B, E, H>{
    ...
    pub fn verify_layer(&mut self, layer_commit: H::Digest, decommit: Vec<Vec<E>>, proof: BatchMerkleProof<H>) -> bool{
    ...
    // run at the end
    pub fn verify_fri_proof(&mut self, last_layer_commit: H::Digest, proof: LowDegreeBatchProof<B,E,H>) -> bool{
        let mut coin = RandomCoin::<B, H>::new(&vec![]);
